var JabatanSkpd = new SkpdCls({
	prefix : 'JabatanSkpd', formName:'JabatanForm',
	
	pilihBidangAfter : function(){Jabatan.refreshList(true);},
	pilihUnitAfter : function(){Jabatan.refreshList(true);},
	pilihSubUnitAfter : function(){Jabatan.refreshList(true);},
	pilihSeksiAfter : function(){Jabatan.refreshList(true);}
});

var Jabatan = new DaftarObj2({
	prefix : 'Jabatan',
	url : 'pages.php?Pg=jabatan', 
	formName : 'JabatanForm',
