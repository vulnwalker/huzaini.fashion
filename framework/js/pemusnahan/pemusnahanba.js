...
var pemusnahanba = new DaftarObj2({
	...
	Baru2: function(){	
		...
		var cover = this.prefix+'_formcover';var skpd = document.getElementById('pemusnahanbaSkpdfmSKPD').value; 
		var unit = document.getElementById('pemusnahanbaSkpdfmUNIT').value;
