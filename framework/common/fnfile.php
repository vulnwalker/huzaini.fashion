...
function tahapPerencanaanV3($namaModul){
		...
		$getSettingan = mysql_fetch_array(mysql_query("select * from settingperencanaan_v3"));
		$tahun = $getSettingan['tahun'];
		$jenis_anggaran = $getSettingan['jenis_anggaran']; 
		$wajib_validasi = $getSettingan['wajib_validasi'];
		$provinsi = $getSettingan['provinsi'];
		$kota = $getSettingan['kota'];
		$getTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran_v3 where id_modul = '$requestor' and tahun = '$tahun' and anggaran = '$jenis_anggaran'"));
...
function tahapKoreksi($namaModul){
		date_default_timezone_set("Asia/Bangkok");
		$getSettingan = mysql_fetch_array(mysql_query("select * from settingperencanaan_v3"));
		$tahun = $getSettingan['tahun'];
		$jenis_anggaran = $getSettingan['jenis_anggaran']; 
		...
		$provinsi = $getSettingan['provinsi'];
		$kota = $getSettingan['kota'];
		$getTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran_v3 where id_modul = '$namaModul' and tahun = '$tahun' and anggaran = '$jenis_anggaran'"));
		if($wajib_validasi == '1')$wajib_validasi = TRUE;
		$getPengelolaBarang = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pengelola']."'"));
		$getPejabat = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pejabat']."'"));
		$getPengurus = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pengurus']."'"));
