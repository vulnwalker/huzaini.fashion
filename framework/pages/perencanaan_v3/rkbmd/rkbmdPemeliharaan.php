	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '$rkbmdPemeliharaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPemeliharaan_v3SkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '$rkbmdPemeliharaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPemeliharaan_v3SkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '$rkbmdPemeliharaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPemeliharaan_v3SkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentrkbmdPemeliharaan_v3 = mysql_fetch_array(mysql_query("select * from view_renja_v3 where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			...
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
					...
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPemeliharaan_v3 = mysql_fetch_array(mysql_query("select * from view_rkbmd_v3 where id_anggaran = '$id[0]'"));
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran_v3 where id_anggaran = '$rkbmdPemeliharaan_v3_idplh'"));
