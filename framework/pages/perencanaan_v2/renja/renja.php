...
if(empty($renja_v2->tahun)){
	...
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$renja_v2->idTahap'"));
	$renja_v2->currentTahap = $getCurrenttahap['nama_tahap'];
	$renja_v2->jenisFormTerakhir =  $namaTahap['jenis_form_modul'];
	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$renja_v2->idTahap'"));
	$renja_v2->namaTahapTerakhir = $namaTahap['nama_tahap'];
	$arrayMasa = explode("-",$namaTahap['tanggal_mulai']);
	$lastTanggalMulai = $arrayMasa[2]."-".$arrayMasa[1]."-".$arrayMasa[0];
	$arrayMasa2 = explode("-",$namaTahap['tanggal_selesai']);
